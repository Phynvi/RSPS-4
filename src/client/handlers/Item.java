...
public class Item {
	...
	public static final int ANTIDRAGONFIRESHIELD = 1540;
	public static final int DFS = 13361;
	public static final int CRYSTALBOW = 4212;
	public static final int DARKBOW = 15156;
	public static final int KARILSCROSSBOW = 4734;
	public static final int ARMADYL_GODSWORD = 15333;
	public static final int BANDOS_GODSWORD = 15334;
	public static final int SARADOMIN_GODSWORD = 15335;
	public static final int ZAMORAK_GODSWORD = 15336;
	public static final int ACCURATE = -100;
	public static final int RAPID = -200;
	...
	public static int GetWepAnim(client c){
		...
		switch(itemID){
		case 7671: case 7673: //boxing gloves
			return 422;
		}
