...
public class ButtonClickHandler {
	...
	public void clickButton(int actionButtonId){
		...
		case 57215: //x black dhide
		case 57214: //x red dhide
		case 57213: //x blue dhide
		case 57212: //x green dhide
		case 57211: //x snakeskin
		...
		case 32017: //4 options, 1st option TODO
			...
			case 0:
				...
				break;
			case 1:
				c.getSkillHandler().getSmithingHandler().smeltBar("Bronze");
				c.getFrameMethodHandler().RemoveAllWindows();
				break;

			case 2:
				c.getSkillHandler().getSmithingHandler().smeltBar("Steel");
				c.getFrameMethodHandler().RemoveAllWindows();
				break;

			case 3:
				c.getSkillHandler().getSmithingHandler().smeltBar("Adamantite");
				c.getFrameMethodHandler().RemoveAllWindows();
				break;
		...
		case 32018: //4 options, 2nd option TODO
			...
			case 1:
				c.getSkillHandler().getSmithingHandler().smeltBar("Iron");
				c.getFrameMethodHandler().RemoveAllWindows();
				break;

			case 2:
				c.getSkillHandler().getSmithingHandler().smeltBar("Gold");
				c.getFrameMethodHandler().RemoveAllWindows();
				break;

			case 3:
				c.getSkillHandler().getSmithingHandler().smeltBar("Rune");
				c.getFrameMethodHandler().RemoveAllWindows();
				break;
		...
		case 32019: //4 options, 3rd option TODO
			...
			case 1:
				c.getSkillHandler().getSmithingHandler().smeltBar("Silver");
				c.getFrameMethodHandler().RemoveAllWindows();
				break;
			case 2:
				c.getSkillHandler().getSmithingHandler().smeltBar("Mithril");
				c.getFrameMethodHandler().RemoveAllWindows();
				break;
		...
		case 32020: //4 options, 4th option TODO
			...
			case 1:
				c.getSkillHandler().getSmithingHandler().smithingBarMenuPage2();
				return;

			case 2:
				c.getSkillHandler().getSmithingHandler().smithingBarMenuPage3();
				return;
