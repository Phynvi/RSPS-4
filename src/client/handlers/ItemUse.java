...
public class ItemUse {
	...
	public boolean checkItemUse(int Item, int Slot) {
		...
		case 952://spade
			...
			if (c.isInArea(3553, 3294, 3561, 3301))  // verac
				c.getClientMethodHandler().teleportWithAnimationDelay(3578,9706,3,2843, 4);
			else if (c.isInArea(3550, 3278, 3557, 3287))  // torag
				c.getClientMethodHandler().teleportWithAnimationDelay(3568,9683,3,2843, 4);
			else if (c.isInArea(3561, 3285, 3568, 3292))  // ahrim
				c.getClientMethodHandler().teleportWithAnimationDelay(3557,9703,3,2843, 4);
			else if (c.isInArea(3570, 3293, 3579, 3302))  // dharok
				c.getClientMethodHandler().teleportWithAnimationDelay(3556,9718,3,2843, 4);
			else if (c.isInArea(3571, 3278, 3582, 3285))  // guthan
				c.getClientMethodHandler().teleportWithAnimationDelay(3534,9704,3,2843, 4);
			else if (c.isInArea(3562, 3273, 3569, 3279))  // karil
				c.getClientMethodHandler().teleportWithAnimationDelay(3546,9684,3,2843, 4);
			else{
	...
	public boolean useItemOnObject(int useItemID, int atObjectID, int atObjectY, int atObjectX, int itemSlot, int objectDirection){
		...
		if(useItemID == 1462 && atObjectID == 2459)
			c.getClientMethodHandler().teleportWithAnimationDelay(2142, 4814, 0,1500, 6);
		...
		if (atObjectID == 2781 || atObjectID == 2785 || atObjectID == 11666 || atObjectID == 3994) //furnace
			c.getSkillHandler().getSmithingHandler().smithingBarMenuPage1();
		//end of smithing
