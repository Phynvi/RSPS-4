...
public class Runecrafting {
	...
	private boolean checkRequirementsAndCraft(int level, double exp, int rune, int multi){
		...
		int totalRunesCrafted = (int)runesToCraft;
		c.debug("totalRunesCrafted: "+totalRunesCrafted);
		c.getInventoryHandler().addItem(rune, totalRunesCrafted);
