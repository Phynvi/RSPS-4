...
public class Slayer {
	...
	public String getTaskName(int npcID){
		if (c.slayerCount == 0) return "none";
		switch(npcID){
	...
	private int midLevelMonsters[] = {1616,1248,1604,1154,1250,55,110,1590};
	private int highLevelMonsters[] = {1608,912,53,1246,1624,1615,84,1591,54,3070,1592,2783};
	...
	private int getEXP(int npcID){		
		...
		case 1616: return 32; //Basilisk - 75
		case 82: return 32; //lesser demon - 79
		case 1246: return 33; //Riyl Shade - 85
		...
		case 1608: return 45; //Kurask - 97
		case 1250: return 40;//Fiyr Shade - 100
		case 1624: return 41; //Dust Devils - 105
	...
	public int getTaskLevel(int npcID){
		switch(npcID){
		case 2850: return 40; //Fever Spider - 40
		case 1616: return 40; //Basilisk - 75
		case 1246: return 45; //Riyl Shade - 85
		case 1248: return 55;//Asyn Shade - 90
		case 1604: return 60; //Aberrant_specter - 90
		case 1608: return 70; //Kurask - 97
		case 1250: return 65;//Fiyr Shade - 100
		case 1624: return 65; //Dust Devils - 105
		case 912: case 913: return 70; //battle mages - 127
		case 3070: return 72; //Skeletal Wyvern - 200
		case 1615: return 85; //abby demons - 150
		case 2783: return 90; //Dark Beast - 220
		default:
			return 0;
		}
	}
