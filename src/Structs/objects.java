...
public class objects{
	...
	public static void newObjects(client c){
		...
		if(c.isInArea(2621, 2557, 2689, 2622)){
			c.makeGlobalObject(2629, 2591, 107, 0, 10);
			c.makeGlobalObject(2629, 2593, 107, 0, 10);
			c.makeGlobalObject(2681, 2588, 107, 0, 10);
			c.makeGlobalObject(2681, 2590, 107, 0, 10);
			c.makeGlobalObject(2671, 2571, 107, 0, 10);
			c.makeGlobalObject(2669, 2571, 107, 0, 10);
			c.makeGlobalObject(2647, 2570, 107, 0, 10);
			c.makeGlobalObject(2645, 2570, 107, 0, 10);
		}
		else{
			...
			c.makeLocalObject(2442, 3124, 4421, 1, 10);
			c.makeLocalObject(2441, 3123, 4421, 1, 10);
