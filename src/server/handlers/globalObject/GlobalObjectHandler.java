package server.handlers.globalObject;
import java.util.LinkedList;

import client.client;
import client.handlers.skills.RockObject;
import client.handlers.skills.TreeObject;
import server.handlers.processes.ServerProcess;
import server.resources.misc;
import server.root.server;

public class GlobalObjectHandler extends ServerProcess{
	...
	public GlobalObjectHandler(String s){
		super(s);
