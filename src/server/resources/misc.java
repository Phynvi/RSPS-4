...
public class misc {
   ...
   public static long playerNameToLong(String s) {
	...
	{
		if(server.debugmode)
			server.DebugStream.print(str);				// comment this line out if you want to get rid of debug messages
	}
	public static void println_debug(String str)
	{
		if(server.debugmode) server.DebugStream.println(str);
	}
	public static void print(String str)
	{
		server.SystemStream.print(str);
	}
	public static void println(String str)
	{
		server.SystemStream.println(str);
	}
