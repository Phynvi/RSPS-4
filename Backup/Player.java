...
public boolean inwildy = true;
public boolean inwildy2 = true;
                public int hptype = 0;
...
public int clanRights = 0;
	...
	public Player(int _playerId) {
		...
		playerEquipment[playerHat]=14087;
		playerEquipment[playerCape]=1052;
		playerEquipment[playerAmulet]=4164;
		playerEquipment[playerChest]=7399;
		playerEquipment[playerShield]=3842;
		playerEquipment[playerLegs]=7398;
		playerEquipment[playerHands]=3060;
...
*/
		...
		teleportToX = 2681;//Deep Haven Start
		teleportToY = 9561;//Deep Haven Start
